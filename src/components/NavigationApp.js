...
const center = { lat: 43.643125539150866, lng: -79.38702471691555 };
  ...
  return (
    ...
    >
      ...
      <Box
        ...
        width={{ base: "calc(100% - 32px)", md: "container.md" }}
      >
        ...
        <HStack spacing={4} mt={4} justifyContent="space-between">
          ...
          <IconButton
            ...
            onClick={() => {
              if (steps.length === 0) {
                alert(
                  "No route calculated yet. Please enter locations and find the route first."
                );
                return;
              }
              setShowSteps(true);
            ...
            <VStack spacing={2} align="center">
              <Text
                ...
                dangerouslySetInnerHTML={{
                  __html: `🚗 ${steps[currentStepIndex].instructions} (${steps[currentStepIndex].distance})`,
                }}
              />
